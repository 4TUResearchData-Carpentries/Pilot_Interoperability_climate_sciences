...
GRIB2 is maintained through the WMO (World Meteorological Organization) Manual on Codes. It represents gridded meteorological fields using standard message sections, templates, parameters, levels, time-processing information, and code tables.
